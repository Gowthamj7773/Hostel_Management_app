...
return (
    ...
    >
        ...
        resizeMode="contain"
        />
        <Text className="mt-2 text-[14px] text-primary">Purchase Request</Text>
    </Pressable>
    ...
    >
        <Image className="w-6 h-6" source={approvals} />
        <Text className="text-lg mt-3 text-primary">Approvals</Text>
    </Pressable>
    ...
    <View className="absolute  bottom-[32px] right-[16px]">
        <View className="flex items-end">
            ...
            <Pressable
            className="h-[56px] w-[56px] bg-primary justify-center mb-4 items-center rounded-2xl"
            ...
            <Pressable className="flex-row items-center bg-primary p-[15px] px-[20px] rounded-2xl">
                <Text className="text-lg text-white">Create </Text>
                <Image className="h-5 w-5 ml-2" source={plus}/>
            </Pressable>
    </View>
