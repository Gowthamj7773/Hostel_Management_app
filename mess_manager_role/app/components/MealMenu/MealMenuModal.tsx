...
const setMeal = require('../../../assets/icons/setMeal.png');
    ...
    return (
        ...
        <View className="flex-1 bg-black/50 justify-center items-center">
            ...
            <View className="flex-row items-center justify-between w-full mb-4">
                ...
                <Feather name="calendar" size={24} color="#4A5B9B" />
                </Pressable>
                <Pressable onPress={()=>router.push('/components/SetMeal/SetMeal')}>
                    <Image className="w-[24px] h-[24px] ml-4" source={setMeal}/>
                </Pressable>
                </View>
            </View>
